...
При установке опции `superuser_access: true` для ограниченного доступа к настройке бота следует указать в конфигурации список ID пользователей в опции `superuser_ids`:
